...
const DetailApplicationType: FC<StaffModalProps> = ({
  isVisible,
  onClose,
  ...
  const handleEdit = (): void => {
    const ApplicationTypeId = staffDetails?.id
    ...
    <Modal
      ...
      title={
        <div className='text-lg font-bold h1'>
          {t(`APPLICATION_TYPE.FORM.DETAIL_APPLICATION_TYPE`)}
        </div>
      }
    >
      {loading && (
      ...
      {!loading && staffDetails && (
        <div className='p-4 space-y-4'>
          <div className='p-3 rounded-md flex items-center'>
            ...
            <p className='text-xs  mx-3 my-auto'>
              {t(`APPLICATION_TYPE.FORM.LABEL.CREATED_TIME`)}:
            </p>
          ...
          <div className='p-3 rounded-md flex items-center'>
            ...
            <p className='text-xs  mx-3 my-auto'>
              {t(`APPLICATION_TYPE.FORM.LABEL.UPDATED_TIME`)}:
            </p>
            <p className='text-sm font-medium my-auto'>
              {moment(staffDetails.createdAt).format('DD/MM/YYYY HH:mm:ss')}
            </p>
          ...
          <div className='space-y-4'>
            ...
            >
              <h3 className='text-sm font-medium mb-2'>
                {t(`APPLICATION_TYPE.FORM.LABEL.SUBJECT`)}
              </h3>
              <p>
          ...
          <div className='flex justify-end'>
            ...
            >
              ...
              {t(`APPLICATION_TYPE.FORM.LABEL.EDIT`)}
            </button>
          </div>
        </div>
      )}
...
export default DetailApplicationType
